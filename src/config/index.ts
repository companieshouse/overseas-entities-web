...
export const TRUST_INDIVIDUAL_BENEFICIAL_OWNER_PAGE = "trust-individual-beneficiary-owner";
...
export const UPDATE_SUB_PATH_SIGN_OUT_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + "**/" + UPDATE_SIGN_OUT_PAGE;
