...
export const CHECK_YOUR_ANSWERS_PAGE_RP_NO_BENEFICIAL_OWNER_STATEMENTS_SUB_TEXT = "The entity has no reasonable cause to believe that anyone has become or ceased to be a registrable beneficial owner during the pre-registration period.";
export const CHECK_YOUR_ANSWERS_PAGE_RP_NO_TRUST_STATEMENTS_TITLE = "Trusts statement";
export const CHECK_YOUR_ANSWERS_PAGE_RP_NO_TRUST_STATEMENTS_SUB_TEXT = "The entity has no reasonable cause to believe that anyone was a registrable beneficial owner due to being a trustee of a trust during the pre-registration period.";
...
export const CHECK_YOUR_ANSWERS_PAGE_RP_BENEFICIAL_OWNER_STATEMENTS_SUB_TEXT = "The entity has reasonable cause to believe that at least one person has become or ceased to be a registrable beneficial owner during the pre-registration period.";
export const CHECK_YOUR_ANSWERS_PAGE_RP_TRUST_STATEMENTS_TITLE = "Trusts statement";
export const CHECK_YOUR_ANSWERS_PAGE_RP_TRUST_STATEMENTS_SUB_TEXT = "The entity has reasonable cause to believe that there was at least one person that was a registrable beneficial owner due to being a trustee of a trust during the pre-registration period.";
export const CHECK_YOUR_ANSWERS_PAGE_RP_BENEFICIARY_STATEMENTS_TITLE = "Beneficiaries statement";
export const CHECK_YOUR_ANSWERS_PAGE_RP_BENEFICIARY_STATEMENTS_SUB_TEXT = "The entity has reasonable cause to believe that at least one person has become or ceased to be a beneficiary of a trust involved in the overseas entity during the pre-registration period.";
