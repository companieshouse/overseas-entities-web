export enum ErrorMessages {
  ...
  DAY_OF_TRUST_CEASED = "The date the trust was ceased must include a day",
  MONTH_OF_TRUST_CEASED = "The date the trust was ceased must include a month",
  YEAR_OF_TRUST_CEASED = "The date the trust was ceased must include a year",
  YEAR_LENGTH_OF_TRUST_CEASED = "The year of the date the trust was ceased must include 4 numbers",
  DAY_LENGTH_OF_TRUST_CEASED = "The day the trust was ceased must include 1 or 2 numbers",
  MONTH_LENGTH_OF_TRUST_CEASED = "The month the trust was ceased must include 1 or 2 numbers",
  ...
  ENTER_DATE_OF_TRUST_CEASED = "Enter the date the trust was ceased",
  ...
  INVALID_DATE_OF_TRUST_CEASED = "The date the trust was ceased must be a real date",
  ...
  DATE_NOT_IN_PAST_OR_TODAY_OF_TRUST_CEASED = "The date the trust was ceased must be today or in the past",
  ...
  DAY_AND_MONTH_OF_TRUST_CEASED = "The trust ceased date must include a day and month",
  MONTH_AND_YEAR = "Date must include a month and year",
  MONTH_AND_YEAR_OF_TRUST = "The trust date must include a month and year",
  MONTH_AND_YEAR_OF_TRUST_CEASED = "The trust ceased date must include a month and year",
  DAY_AND_YEAR = "Date must include a day and year",
  DAY_AND_YEAR_OF_TRUST = "The trust date must include a day and year",
  DAY_AND_YEAR_OF_TRUST_CEASED = "The trust ceased date must include a day and year",
