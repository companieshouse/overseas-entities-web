...
export const CONFIRM_OVERSEAS_ENTITY_PROFILES_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + CONFIRM_OVERSEAS_ENTITY_DETAILS_PAGE;
export const UPDATE_OVERSEAS_ENTITY_DETAILS_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + UPDATE_OVERSEAS_ENTITY_DETAILS_PAGE;
...
export const UPDATE_ENTITY_CHANGE_NAME = UPDATE_ENTITY_URL + NAME;
export const UPDATE_ENTITY_CHANGE_COUNTRY = UPDATE_ENTITY_URL + "#incorporation_country";
export const UPDATE_ENTITY_CHANGE_PRINCIPAL_ADDRESS = UPDATE_ENTITY_URL + CHANGE_PRINCIPAL_ADDRESS;
export const UPDATE_ENTITY_CHANGE_CORRESPONDENCE_ADDRESS = UPDATE_ENTITY_URL + CHANGE_SERVICE_ADDRESS;
export const UPDATE_ENTITY_CHANGE_EMAIL = UPDATE_ENTITY_URL + EMAIL;
export const UPDATE_ENTITY_CHANGE_LEGAL_FORM = UPDATE_ENTITY_URL + LEGAL_FORM;
export const UPDATE_ENTITY_CHANGE_GOVERNING_LAW = UPDATE_ENTITY_URL + LAW_GOVERNED;
export const UPDATE_ENTITY_CHANGE_PUBLIC_REGISTER = UPDATE_ENTITY_URL + "#is_on_register_in_country_formed_in";
