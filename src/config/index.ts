...
export const UPDATE_REVIEW_STATEMENT_BEFORE_SUBMITTING_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + UPDATE_REVIEW_STATEMENT_PAGE;
...
export const BO_STATEMENTS_SECTION_HEADING = "Beneficial owner statements";
export const BENEFICIAL_OWNERS_SECTION_HEADING = "Beneficial owners";
