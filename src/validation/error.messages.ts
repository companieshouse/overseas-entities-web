export enum ErrorMessages {
  ...
  INVALID_START_DATE_HISTORICAL_BO = "The date they became a benefical owner must be a real date",
  INVALID_END_DATE_HISTORICAL_BO = "The date they stopped being a benefical owner must be a real date",
...
// MAX Lengths
  ...
  NAME_INVALID_CHARACTERS_TRUST = "The trust name must only include letters a to z, numbers, and special characters such as hyphens, spaces and apostrophes",
