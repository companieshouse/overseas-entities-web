...
import { checkTrustValidation, checkValidations } from "../middleware/validation.middleware";
...
router.post(config.TRUST_INFO_URL, authentication, navigation.hasBOsOrMOs, ...validator.trustInformation, checkTrustValidation, trustInformation.post);
