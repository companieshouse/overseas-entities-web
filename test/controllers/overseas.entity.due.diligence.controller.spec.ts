...
import {
  ...
  OVERSEAS_ENTITY_DUE_DILIGENCE_ALL_OTHER_INFORMATION_ON_PUBLIC_REGISTER,
...
describe("OVERSEAS_ENTITY_DUE_DILIGENCE controller", () => {
  ...
  describe("GET tests", () => {
    ...
    test(`renders the ${OVERSEAS_ENTITY_DUE_DILIGENCE_PAGE}`, async () => {
      ...
      expect(resp.text).toContain(OVERSEAS_ENTITY_DUE_DILIGENCE_ALL_OTHER_INFORMATION_ON_PUBLIC_REGISTER);
