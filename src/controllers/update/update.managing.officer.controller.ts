...
export const post = async (req: Request, res: Response, next: NextFunction) => {
  await postManagingOfficer(req, res, next, UPDATE_BENEFICIAL_OWNER_TYPE_URL);
};
...
export const update = async (req: Request, res: Response, next: NextFunction) => {
  await updateManagingOfficer(req, res, next, UPDATE_BENEFICIAL_OWNER_TYPE_URL);
};

export const remove = async (req: Request, res: Response, next: NextFunction) => {
  await removeManagingOfficer(req, res, next, UPDATE_BENEFICIAL_OWNER_TYPE_URL);
};
