...
export const mapIndividualTrusteeFromSessionToPage = (
  ...
  const data = {
    ...
    usual_residential_address_property_name_number: trustee.ura_address_premises ?? trustee?.usual_residential_address?.property_name_number,
    usual_residential_address_line_1: trustee.ura_address_line_1 ?? trustee?.usual_residential_address?.line_1,
    usual_residential_address_line_2: trustee.ura_address_line_2 ?? trustee?.usual_residential_address?.line_2,
    usual_residential_address_town: trustee.ura_address_locality ?? trustee?.usual_residential_address?.town,
    usual_residential_address_county: trustee.ura_address_region ?? trustee?.usual_residential_address?.county,
    usual_residential_address_country: trustee.ura_address_country ?? trustee?.usual_residential_address?.country,
    usual_residential_address_postcode: trustee.ura_address_postal_code ?? trustee?.usual_residential_address?.postcode,
