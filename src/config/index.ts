...
export const FEATURE_FLAG_ENABLE_REDIS_REMOVAL = getEnvironmentValue('FEATURE_FLAG_ENABLE_REDIS_REMOVAL_27092023');
...
export const ACTIVE_SUBMISSION_BASE_PATH = `transaction/:${ROUTE_PARAM_TRANSACTION_ID}/overseas-entity/:${ROUTE_PARAM_OVERSEAS_ENTITY_ID}/`;
export const REGISTER_AN_OVERSEAS_ENTITY_WITH_PARAMS_URL = LANDING_URL + "/" + ACTIVE_SUBMISSION_BASE_PATH;
