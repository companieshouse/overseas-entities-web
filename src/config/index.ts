...
const IDENTITY_DATE = "#identity_date-day";
const IDENTITY_NAME = "#name";
const IDENTITY_ADDRESS = "#identity_address_property_name_number";
const SUPERVISORY_NAME = "#supervisory_name";
const AML_NUMBER = "#aml_number";
...
export const DUE_DILIGENCE_CHANGE_NAME = DUE_DILIGENCE_URL + IDENTITY_NAME;
...
export const OVERSEAS_ENTITY_DUE_DILIGENCE_CHANGE_WHO = WHO_IS_MAKING_FILING_URL;
export const OVERSEAS_ENTITY_DUE_DILIGENCE_CHANGE_IDENTITY_DATE = OVERSEAS_ENTITY_DUE_DILIGENCE_URL + IDENTITY_DATE;
export const OVERSEAS_ENTITY_DUE_DILIGENCE_CHANGE_NAME = OVERSEAS_ENTITY_DUE_DILIGENCE_URL + IDENTITY_NAME;
export const OVERSEAS_ENTITY_DUE_DILIGENCE_CHANGE_IDENTITY_ADDRESS = OVERSEAS_ENTITY_DUE_DILIGENCE_URL + IDENTITY_ADDRESS;
export const OVERSEAS_ENTITY_DUE_DILIGENCE_CHANGE_EMAIL = DUE_DILIGENCE_URL + EMAIL;
