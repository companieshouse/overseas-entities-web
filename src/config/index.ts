...
export const UPDATE_STATEMENT_BO_CEASE_PAGE = "did-anyone-become-or-cease-to-be-a-beneficial-owner-during-the-relevant-period";
...
export const UPDATE_STATEMENT_BO_CEASE_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + UPDATE_STATEMENT_BO_CEASE_PAGE;
