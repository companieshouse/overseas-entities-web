...
export const UPDATE_MANAGING_OFFICER_TYPE_PAGE = "update-managing-officer-type";
export const UPDATE_MANAGING_OFFICER_INDIVIDUAL_PAGE = "update-managing-officer-individual";
...
export const UPDATE_MANAGING_OFFICER_TYPE_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + UPDATE_MANAGING_OFFICER_TYPE_PAGE;
export const UPDATE_MANAGING_OFFICER_TYPE_SUBMIT_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + UPDATE_MANAGING_OFFICER_TYPE_PAGE + SUBMIT_URL;
export const UPDATE_MANAGING_OFFICER_INDIVIDUAL_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + UPDATE_MANAGING_OFFICER_INDIVIDUAL_PAGE;
