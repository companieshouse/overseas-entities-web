...
export const OVERSEAS_ENTITY_PRESENTER_PAGE = "overseas-entity-presenter";
...
export const OVERSEAS_ENTITY_PRESENTER_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + OVERSEAS_ENTITY_PRESENTER_PAGE;
