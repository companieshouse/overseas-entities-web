...
import { TRUST_INVOLVED_URL, TRUST_INDIVIDUAL_BENEFICIAL_OWNER_URL } from '../../src/config';
...
describe('Trust Individual Beneficial Owner Controller', () => {
  ...
  const pageUrl = TRUST_INVOLVED_URL + "/" + trustId + TRUST_INDIVIDUAL_BENEFICIAL_OWNER_URL;
