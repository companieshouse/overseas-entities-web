...
import { CHANGE_COMPANY_TEST, CONFIRM_AND_CONTINUE_BUTTON_TEXT, CONFIRM_OVERSEAS_ENTITY_PAGE_TITLE, UPDATE_OVERSEAS_ENTITY_PAGE_TITLE } from "../__mocks__/text.mock";
import { APPLICATION_DATA_MOCK, COMPANY_NUMBER, OVER_SEAS_ENTITY_MOCK_DATA } from "../__mocks__/session.mock";
import { getCompanyRequest, getOverseasEntity } from "../../src/service/overseas.entities.service";
import { getApplicationData, setApplicationData, setExtraData } from "../../src/utils/application.data";
import { companyProfileKey } from "../../src/model/data.types.model";
...
describe("Confirm company data", () => {
  ...
  describe("Get company data by Id", () => {
    ...
    test(`redirect to the ${config.UPDATE_OVERSEAS_ENTITY_DETAILS_PAGE} page`, async () => {
      mockGetOeCompanyDetails.mockReturnValue( {...APPLICATION_DATA_MOCK, [companyProfileKey]: {}} );
