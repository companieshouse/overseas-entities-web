...
export const TRUST_DATE_OF_BIRTH = "#dateOfBirth";
export const INTERESTED_PERSON_START_DATE = "#dateBecameIP";
...
export const TRUSTEE_START_DATE = "#startDate";
export const TRUSTEE_END_DATE = "#endDate";
