...
export const TRUST_BENEFICIAL_OWNER_DETACH_PAGE = "bo-detach";
...
export const TRUST_ENTRY_URL = REGISTER_AN_OVERSEAS_ENTITY_URL + 'trust';
...
export const TRUST_TRUSTEE_HISTORICAL_INDIVIDUAL_URL = '/trustee-historical-individual';
export const TRUST_TRUSTEE_HISTORICAL_OTHER_URL = '/trustee-historical-other';
...
export const BO_ID = "/:boId"; // Same param name as the ID in the data model
