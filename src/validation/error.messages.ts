export enum ErrorMessages {
  ...
  DATE_BEFORE_TRUST_CREATION_DATE_INTERSTED_TRUSTEE = "The date they became interested in the trust must be on or after the date the trust was created",
  DATE_BEFORE_DATE_OF_BIRTH_INTERSTED_TRUSTEE = "The date they became interested in the trust must be on or after their date of birth",
