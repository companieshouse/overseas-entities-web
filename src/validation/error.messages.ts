export enum ErrorMessages {
  ...
  DAY_OF_CEASED_TRUST_INDIVIDUAL = "The date they ceased being involved in the trust must include a day",
  DAY_LENGTH_OF_CEASED_TRUST_INDIVIDUAL = "The day of the date they ceased being involved in the trust must include 1 or 2 numbers",
  MONTH_OF_CEASED_TRUST_INDIVIDUAL = "The date they ceased being involved in the trust must include a month",
  MONTH_LENGTH_OF_CEASED_TRUST_INDIVIDUAL = "The month of the date they ceased being involved in the trust must include 1 or 2 numbers",
  YEAR_OF_CEASED_TRUST_INDIVIDUAL = "The date they ceased being involved in the trust must include a year",
  YEAR_LENGTH_OF_CEASED_TRUST_INDIVIDUAL = "The year of the date they ceased being involved in the trust must include 4 numbers",
  ENTER_DATE_OF_TRUST_CEASED_INDIVIDUAL = "Enter the date they ceased being involved in the trust",
  DAY_AND_MONTH_OF_CEASED_TRUST_INDIVIDUAL = "The date they ceased being involved in the trust must include a day and month",
  MONTH_AND_YEAR_OF_CEASED_TRUST_INDIVIDUAL = "The date they ceased being involved in the trust must include a month and year",
  DAY_AND_YEAR_OF_CEASED_TRUST_INDIVIDUAL = "The date they ceased being involved in the trust must include a day and year",
  INVALID_DATE_OF_CEASED_TRUST_INDIVIDUAL = "The date they ceased being involved in the trust must be a real date",
  DATE_NOT_IN_PAST_OR_TODAY_OF_CEASED_TRUST_INDIVIDUAL = "The date they ceased being involved in the trust cannot be in the future",
  TRUST_INDIVIDUAL_CEASED_DATE_BEFORE_BIRTH_DATE = "The date they ceased being involved in the trust must be on or after their date of birth",
  TRUST_INDIVIDUAL_CEASED_DATE_BEFORE_TRUST_CREATION_DATE = "The date they ceased being involved in the trust must be on or after the date the trust was created",
  TRUST_INDIVIDUAL_CEASED_DATE_BEFORE_INTERESTED_PERSON_START_DATE = "The date they ceased being involved in the trust must be on or after the date they became an interested person",
