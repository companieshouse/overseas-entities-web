export enum ErrorMessages {
  ...
  PUBLIC_REGISTRATION_NUMBER_INVALID_CHARACTERS = "Entity’s registration number must only include letters a to z, numbers, and special characters such as hyphens, spaces and apostrophes",
