...
export const RELEVANT_PERIOD_DO_YOU_WANT_TO_PROVIDE_PRE_REG_INFO_NOW_PAGE = "relevant-period-provide-info-now-or-later-question-page";
...
export const RELEVANT_PERIOD_PROVIDE_INFORMATION_NOW_OR_LATER_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + RELEVANT_PERIOD_DO_YOU_WANT_TO_PROVIDE_PRE_REG_INFO_NOW_PAGE;
