...
export const entity_public_register_validations = [
  body("public_register_name")
    ...
    .custom((value, { req }) => checkMaxFieldIfRadioButtonSelected(req.body.is_on_register_in_country_formed_in === '1', ErrorMessages.MAX_ENTITY_PUBLIC_REGISTER_NAME_LENGTH, 160, value) )
  ...
  body("public_register_jurisdiction")
    ...
    .custom((value, { req }) => checkPublicRegisterJurisdiction(req.body["public_register_name"], value)),
