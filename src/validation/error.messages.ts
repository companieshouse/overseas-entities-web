export enum ErrorMessages {
  ...
  ENTER_HISTORICAL_BO_DATE = "Enter the date they became a beneficial owner",
  ENTER_HISTORICAL_BO_END_DATE = "Enter the date they stopped being a beneficial owner",
