...
export const public_register_validations = [
  ...
  body("registration_number")
    ...
    .custom((value, { req }) => checkInvalidCharactersIfRadioButtonSelected(req.body.is_on_register_in_country_formed_in === '1', ErrorMessages.PUBLIC_REGISTRATION_NUMBER_INVALID_CHARACTERS, value) )
];
