...
export const NAVIGATION: Navigation = {
  ...
  [config.RELEVANT_PERIOD_REQUIRED_INFORMATION_CONFIRM_URL]: {
    ...
    nextPage: [config.RELEVANT_PERIOD_PROVIDE_INFORMATION_NOW_OR_LATER_URL, config.RELEVANT_PERIOD_SUBMIT_BY_PAPER_PAGE]
  },
  [config.RELEVANT_PERIOD_PROVIDE_INFORMATION_NOW_OR_LATER_URL]: {
    currentPage: config.RELEVANT_PERIOD_DO_YOU_WANT_TO_PROVIDE_PRE_REG_INFO_NOW_PAGE,
