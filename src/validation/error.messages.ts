export enum ErrorMessages {
  ...
  INVALID_DATE_OF_TRUST = "The date the trust was created must be a real date. For example, day or month must not start with a 0.",
  INVALID_DATE_OF_BIRTH = "Date of birth must be a real date. For example, day or month must not start with a 0.",
  ...
  INVALID_START_DATE_HISTORICAL_BO = "The date they became a beneficial owner must be a real date. For example, day or month must not start with a 0.",
  INVALID_END_DATE_HISTORICAL_BO = "The date they stopped being a beneficial owner must be a real date. For example, day or month must not start with a 0.",
