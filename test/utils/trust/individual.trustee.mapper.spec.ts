...
describe('Individual Beneficial Owner page Mapper Service', () => {
  ...
  describe('To Session mapper methods test', () => {
    describe('Individual Beneficial Owner mapper', () => {
      ...
      test.each(testParam)('map Individual trustees', (id, itemType) => {
        const mockFormData = {
          ...mockFormDataBasic,
          trusteeId: id,
          type: itemType,
        ...
        expect(mapIndividualTrusteeToSession(<Page.IndividualTrusteesFormCommon>mockFormData)).toEqual({
          ...
          sa_address_premises: mockFormData.property_name,
          sa_address_line1: mockFormData.address_line1,
          sa_address_line2: mockFormData.address_line2,
          sa_address_locality: mockFormData.city,
          sa_address_region: mockFormData.county,
          sa_address_country: mockFormData.country,
          sa_address_postal_code: mockFormData.postal_code,
          ura_address_premises: mockFormData.correspondence_property_name,
          ura_address_line1: mockFormData.correspondence_address_line1,
          ura_address_line2: mockFormData.correspondence_address_line2,
          ura_address_locality: mockFormData.correspondence_city,
          ura_address_region: mockFormData.correspondence_county,
          ura_address_country: mockFormData.correspondence_country,
          ura_address_postal_code: mockFormData.correspondence_postal_code,
          ura_address_po_box: '',
          ura_address_care_of: '',
        });
      });
