...
export const UPDATE_NO_CHANGE_REGISTRABLE_BENEFICIAL_OWNER_PAGE = "no_change_registrable_beneficial_owner";
export const UPDATE_TRUSTS_SUBMIT_BY_PAPER_PAGE = "update-trusts-submit-by-paper";
export const UPDATE_NO_CHANGE_BENEFICIAL_OWNER_STATEMENTS_PAGE = "update_no_change_beneficial-owner-statements";
...
export const UPDATE_NO_CHANGE_BENEFICIAL_OWNER_STATEMENT_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + UPDATE_NO_CHANGE_BENEFICIAL_OWNER_STATEMENTS_PAGE;
