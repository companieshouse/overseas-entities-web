...
describe("BENEFICIAL OWNER OTHER controller", () => {
  ...
  describe("POST tests", () => {
    ...
    test(`Renders the ${BENEFICIAL_OWNER_OTHER_PAGE} page with only INVALID_DATE error when start date day is outside valid numbers with leading zero`, async () => {
      const beneficialOwnerOther = { ...BENEFICIAL_OWNER_OTHER_REQ_BODY_OBJECT_MOCK_FOR_START_DATE };
    ...
    test(`Renders the ${BENEFICIAL_OWNER_OTHER_PAGE} page with only YEAR_LENGTH error when start date year is not 4 digits with leading zero`, async () => {
      const beneficialOwnerOther = { ...BENEFICIAL_OWNER_OTHER_REQ_BODY_OBJECT_MOCK_FOR_START_DATE };
      beneficialOwnerOther["start_date-day"] = "30";
      beneficialOwnerOther["start_date-month"] = "11";
    ...
    test(`Renders the ${BENEFICIAL_OWNER_OTHER_PAGE} page with only INVALID_DATE error when start date month is outside valid numbers with leading zero`, async () => {
      const beneficialOwnerOther = { ...BENEFICIAL_OWNER_OTHER_REQ_BODY_OBJECT_MOCK_FOR_START_DATE };
      beneficialOwnerOther["start_date-day"] = "30";
    ...
    test(`Renders the ${BENEFICIAL_OWNER_OTHER_PAGE} page with only missing DAY error when start date day is zero`, async () => {
      const beneficialOwnerOther = { ...BENEFICIAL_OWNER_OTHER_REQ_BODY_OBJECT_MOCK_FOR_START_DATE };
    ...
    test(`Renders the ${BENEFICIAL_OWNER_OTHER_PAGE} page with only missing MONTH error when start date month is zero`, async () => {
      const beneficialOwnerOther = { ...BENEFICIAL_OWNER_OTHER_REQ_BODY_OBJECT_MOCK_FOR_START_DATE };
      beneficialOwnerOther["start_date-day"] = "30";
    ...
    test(`Renders the ${BENEFICIAL_OWNER_OTHER_PAGE} page with only missing YEAR error when start date year is zero`, async () => {
      const beneficialOwnerOther = { ...BENEFICIAL_OWNER_OTHER_REQ_BODY_OBJECT_MOCK_FOR_START_DATE };
      beneficialOwnerOther["start_date-day"] = "30";
      beneficialOwnerOther["start_date-month"] = "11";
    ...
    test(`leading zeros are stripped from start date`, async () => {
      mockPrepareData.mockReturnValueOnce({ ...BENEFICIAL_OWNER_OTHER_OBJECT_MOCK, [IsOnSanctionsListKey]: "0" });
      const beneficialOwnerOther = { ...BENEFICIAL_OWNER_OTHER_BODY_OBJECT_MOCK_WITH_ADDRESS };
      beneficialOwnerOther["start_date-day"] = "0030";
      beneficialOwnerOther["start_date-month"] = "0011";
      beneficialOwnerOther["start_date-year"] = "001234";
