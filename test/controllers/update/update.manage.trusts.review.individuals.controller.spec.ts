...
import { UPDATE_MANAGE_TRUSTS_REVIEW_FORMER_BO_URL, UPDATE_MANAGE_TRUSTS_REVIEW_INDIVIDUALS_URL, UPDATE_MANAGE_TRUSTS_REVIEW_LEGAL_ENTITIES_URL } from '../../../src/config';
...
describe('Update - Manage Trusts - Review individuals', () => {
  ...
  describe('POST tests', () => {
    test('when feature flag is on, redirect to review legal entities page', async () => {
      mockIsActiveFeature.mockReturnValue(true);
