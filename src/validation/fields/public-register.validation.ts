...
export const public_register_validations = [
  body("public_register_name")
    ...
    .custom((value, { req }) => checkInvalidCharactersIfRadioButtonSelected(req.body.is_on_register_in_country_formed_in === '1', ErrorMessages.REGISTER_NAME_INVALID_CHARACTERS, value) ),
  body("registration_number")
    ...
    .custom((value, { req }) => checkInvalidCharactersIfRadioButtonSelected(req.body.is_on_register_in_country_formed_in === '1', ErrorMessages.REGISTRATION_NUMBER_INVALID_CHARACTERS, value) )
];

// Checking only MAX for BOs fields
