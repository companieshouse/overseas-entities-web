...
export const RELEVANT_PERIOD_REQUIRED_INFORMATION_CONFIRM_PAGE = "relevant-period-required-information-confirm";
...
export const UPDATE_SUB_PATH_SIGN_OUT_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + DYNAMIC_SUB_PATH + UPDATE_SIGN_OUT_PAGE;
...
export const RELEVANT_PERIOD_REQUIRED_INFORMATION_CONFIRM_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + RELEVANT_PERIOD_REQUIRED_INFORMATION_CONFIRM_PAGE;
export const RELEVANT_PERIOD_SUBMIT_BY_PAPER_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + RELEVANT_PERIOD_SUBMIT_BY_PAPER_PAGE;
...
export const USE_PAPER_WITH_PARAMS_URL = REGISTER_AN_OVERSEAS_ENTITY_WITH_PARAMS_URL + USE_PAPER_PAGE;
export const CANNOT_USE_WITH_PARAMS_URL = REGISTER_AN_OVERSEAS_ENTITY_WITH_PARAMS_URL + CANNOT_USE_PAGE;
...
export const WHO_IS_MAKING_UPDATE_WITH_PARAMS_URL = UPDATE_AN_OVERSEAS_ENTITY_WITH_PARAMS_URL + WHO_IS_MAKING_UPDATE_PAGE;
...
// Update configs with index query
export const UPDATE_REVIEW_BENEFICIAL_OWNER_INDIVIDUAL_WITH_INDEX_URL = UPDATE_REVIEW_BENEFICIAL_OWNER_INDIVIDUAL_URL + REVIEW_OWNER_INDEX_PARAM + ID;
export const UPDATE_REVIEW_BENEFICIAL_OWNER_OTHER_WITH_INDEX_URL = UPDATE_REVIEW_BENEFICIAL_OWNER_OTHER_URL + REVIEW_OWNER_INDEX_PARAM + ID;
export const UPDATE_REVIEW_BENEFICIAL_OWNER_GOV_WITH_INDEX_URL = UPDATE_REVIEW_BENEFICIAL_OWNER_GOV_URL + REVIEW_OWNER_INDEX_PARAM + ID;
export const UPDATE_REVIEW_INDIVIDUAL_MANAGING_OFFICER_WITH_INDEX_URL = UPDATE_REVIEW_INDIVIDUAL_MANAGING_OFFICER_URL + REVIEW_OWNER_INDEX_PARAM + ID;
export const UPDATE_REVIEW_MANAGING_OFFICER_CORPORATE_WITH_INDEX_URL = UPDATE_REVIEW_MANAGING_OFFICER_CORPORATE_URL + REVIEW_OWNER_INDEX_PARAM + ID;

// Update configs with params, with index query
export const UPDATE_REVIEW_BENEFICIAL_OWNER_INDIVIDUAL_WITH_PARAMS_WITH_INDEX_URL = UPDATE_REVIEW_BENEFICIAL_OWNER_INDIVIDUAL_WITH_PARAMS_URL + REVIEW_OWNER_INDEX_PARAM + ID;
export const UPDATE_REVIEW_BENEFICIAL_OWNER_OTHER_WITH_PARAMS_WITH_INDEX_URL = UPDATE_REVIEW_BENEFICIAL_OWNER_OTHER_WITH_PARAMS_URL + REVIEW_OWNER_INDEX_PARAM + ID;
export const UPDATE_REVIEW_BENEFICIAL_OWNER_GOV_WITH_PARAMS_WITH_INDEX_URL = UPDATE_REVIEW_BENEFICIAL_OWNER_GOV_WITH_PARAMS_URL + REVIEW_OWNER_INDEX_PARAM + ID;
export const UPDATE_REVIEW_INDIVIDUAL_MANAGING_OFFICER_WITH_PARAMS_WITH_INDEX_URL = UPDATE_REVIEW_INDIVIDUAL_MANAGING_OFFICER_WITH_PARAMS_URL + REVIEW_OWNER_INDEX_PARAM + ID;
export const UPDATE_REVIEW_MANAGING_OFFICER_CORPORATE_WITH_PARAMS_WITH_INDEX_URL = UPDATE_REVIEW_MANAGING_OFFICER_CORPORATE_WITH_PARAMS_URL + REVIEW_OWNER_INDEX_PARAM + ID;
...
// UPDATE change links, with params
export const UPDATE_DUE_DILIGENCE_CHANGE_WHO_WITH_PARAMS = WHO_IS_MAKING_UPDATE_WITH_PARAMS_URL;
export const UPDATE_DUE_DILIGENCE_CHANGE_IDENTITY_DATE_WITH_PARAMS = UPDATE_DUE_DILIGENCE_WITH_PARAMS_URL + IDENTITY_DATE;
export const UPDATE_DUE_DILIGENCE_CHANGE_NAME_WITH_PARAMS = UPDATE_DUE_DILIGENCE_WITH_PARAMS_URL + NAME;
export const UPDATE_DUE_DILIGENCE_CHANGE_IDENTITY_ADDRESS_WITH_PARAMS = UPDATE_DUE_DILIGENCE_WITH_PARAMS_URL + IDENTITY_ADDRESS;
export const UPDATE_DUE_DILIGENCE_CHANGE_EMAIL_WITH_PARAMS = UPDATE_DUE_DILIGENCE_WITH_PARAMS_URL + EMAIL;
export const UPDATE_DUE_DILIGENCE_CHANGE_SUPERVISORY_NAME_WITH_PARAMS = UPDATE_DUE_DILIGENCE_WITH_PARAMS_URL + SUPERVISORY_NAME;
export const UPDATE_DUE_DILIGENCE_CHANGE_AML_NUMBER_WITH_PARAMS = UPDATE_DUE_DILIGENCE_WITH_PARAMS_URL + AML_NUMBER;
export const UPDATE_DUE_DILIGENCE_CHANGE_AGENT_CODE_WITH_PARAMS = UPDATE_DUE_DILIGENCE_WITH_PARAMS_URL + AGENT_CODE;
export const UPDATE_DUE_DILIGENCE_CHANGE_PARTNER_NAME_WITH_PARAMS = UPDATE_DUE_DILIGENCE_WITH_PARAMS_URL + PARTNER_NAME;

export const UPDATE_OVERSEAS_ENTITY_DUE_DILIGENCE_CHANGE_IDENTITY_DATE_WITH_PARAMS = UPDATE_DUE_DILIGENCE_OVERSEAS_ENTITY_WITH_PARAMS_URL + IDENTITY_DATE;
export const UPDATE_OVERSEAS_ENTITY_DUE_DILIGENCE_CHANGE_NAME_WITH_PARAMS = UPDATE_DUE_DILIGENCE_OVERSEAS_ENTITY_WITH_PARAMS_URL + NAME;
export const UPDATE_OVERSEAS_ENTITY_DUE_DILIGENCE_CHANGE_IDENTITY_ADDRESS_WITH_PARAMS = UPDATE_DUE_DILIGENCE_OVERSEAS_ENTITY_WITH_PARAMS_URL + IDENTITY_ADDRESS;
export const UPDATE_OVERSEAS_ENTITY_DUE_DILIGENCE_CHANGE_EMAIL_WITH_PARAMS = UPDATE_DUE_DILIGENCE_OVERSEAS_ENTITY_WITH_PARAMS_URL + EMAIL;
export const UPDATE_OVERSEAS_ENTITY_DUE_DILIGENCE_CHANGE_SUPERVISORY_NAME_WITH_PARAMS = UPDATE_DUE_DILIGENCE_OVERSEAS_ENTITY_WITH_PARAMS_URL + SUPERVISORY_NAME;
export const UPDATE_OVERSEAS_ENTITY_DUE_DILIGENCE_CHANGE_AML_NUMBER_WITH_PARAMS = UPDATE_DUE_DILIGENCE_OVERSEAS_ENTITY_WITH_PARAMS_URL + AML_NUMBER;
export const UPDATE_OVERSEAS_ENTITY_DUE_DILIGENCE_CHANGE_PARTNER_NAME_WITH_PARAMS = UPDATE_DUE_DILIGENCE_OVERSEAS_ENTITY_WITH_PARAMS_URL + PARTNER_NAME;

export const UPDATE_PRESENTER_CHANGE_FULL_NAME_WITH_PARAMS = OVERSEAS_ENTITY_PRESENTER_WITH_PARAMS_URL + FULL_NAME;
export const UPDATE_PRESENTER_CHANGE_EMAIL_WITH_PARAMS = OVERSEAS_ENTITY_PRESENTER_WITH_PARAMS_URL + EMAIL;
export const SECURE_UPDATE_FILTER_CHANGELINK_WITH_PARAMS = SECURE_UPDATE_FILTER_WITH_PARAMS_URL + SECURE_FILTER;
export const UPDATE_FILING_DATE_CHANGELINK_WITH_PARAMS = UPDATE_FILING_DATE_WITH_PARAMS_URL + FILING_DATE;
export const UPDATE_DO_YOU_WANT_TO_MAKE_OE_CHANGE_CHANGELINK_WITH_PARAMS = UPDATE_DO_YOU_WANT_TO_MAKE_OE_CHANGE_WITH_PARAMS_URL + NO_CHANGE;
export const UPDATE_NO_CHANGE_BENEFICIAL_OWNER_STATEMENTS_CHANGELINK_WITH_PARAMS = UPDATE_NO_CHANGE_BENEFICIAL_OWNER_STATEMENTS_WITH_PARAMS_URL + BENEFICIAL_OWNERS_STATEMENT;
export const UPDATE_NO_CHANGE_REGISTRABLE_BENEFICIAL_OWNER_CHANGELINK_WITH_PARAMS = UPDATE_NO_CHANGE_REGISTRABLE_BENEFICIAL_OWNER_WITH_PARAMS_URL + REGISTRABLE_BENEFICIAL_OWNER;
