import { CreatePaymentRequestResource, Payment } from "@companieshouse/api-sdk-node/dist/services/payment";
...
export const PAYMENT_OBJECT_MOCK: CreatePaymentRequestResource = {
  redirect_uri: PAYMENT_WITH_TRANSACTION_URL,
