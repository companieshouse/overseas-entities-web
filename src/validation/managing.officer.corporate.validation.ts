...
export const managingOfficerCorporate = [
  ...
  body("start_date").custom((value, { req }) => checkDate(req.body["start_date-day"], req.body["start_date-month"], req.body["start_date-year"], ErrorMessages.MANAGING_OFFICER_START_DATE) ),
