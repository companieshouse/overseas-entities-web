...
import { PAYMENT_PAID, UPDATE_CHECK_YOUR_ANSWERS_URL, UPDATE_CONFIRMATION_PAGE, UPDATE_CONFIRMATION_URL, PAYMENT_FAILED_PAGE, UPDATE_PAYMENT_FAILED_URL } from "../../../src/config";
