...
import { checkDate, checkDateIsNotFuture } from "../custom.validation";
import { ErrorMessages } from "../error.messages";

export const start_date_validations = [
  body("start_date")
    .custom((value, { req }) => checkDate(ErrorMessages.MANAGING_OFFICER_START_DATE, req.body["start_date-day"], req.body["start_date-month"], req.body["start_date-year"]))
    .custom((value, { req }) => checkDateIsNotFuture(ErrorMessages.FUTURE_DATE, req.body["start_date-day"], req.body["start_date-month"], req.body["start_date-year"])),
