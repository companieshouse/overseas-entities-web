...
export const COMBINED_PAGE_FOR_STATEMENTS = "combined-page-for-statements";
...
export const COMBINED_PAGE_FOR_STATEMENTS_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + COMBINED_PAGE_FOR_STATEMENTS;
