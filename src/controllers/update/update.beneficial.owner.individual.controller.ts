...
export const getById = async (req: Request, res: Response, next: NextFunction) => {
  ...
  if (checkRelevantPeriod(appData)) {
    await getBeneficialOwnerIndividualById(req, res, next, UPDATE_BENEFICIAL_OWNER_INDIVIDUAL_PAGE, UPDATE_BENEFICIAL_OWNER_TYPE_URL + RELEVANT_PERIOD_QUERY_PARAM);
  } else {
