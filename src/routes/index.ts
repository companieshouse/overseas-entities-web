...
router.get([config.PRESENTER_URL, config.PRESENTER_WITH_PARAMS_URL], authentication, navigation.hasOverseasName, presenter.get);
router.post([config.PRESENTER_URL, config.PRESENTER_WITH_PARAMS_URL], authentication, navigation.hasOverseasName, ...validator.presenter, checkValidations, presenter.post);
