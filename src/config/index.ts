...
export const UPDATE_OVERSEAS_ENTITY_DETAILS_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + ENTITY_PAGE;
export const CONFIRM_OVERSEAS_ENTITY_PROFILES_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + CONFIRM_OVERSEAS_ENTITY_DETAILS_PAGE;
export const UPDATE_OVERSEAS_ENTITY_REVIEW_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + UPDATE_OVERSEAS_ENTITY_REVIEW_PAGE;
