...
export const NAVIGATION: Navigation = {
  [config.SOLD_LAND_FILTER_URL]: {
    ...
    nextPage: [config.SECURE_REGISTER_FILTER_URL, config.CANNOT_USE_URL]
  },
  [config.SECURE_REGISTER_FILTER_URL]: {
    currentPage: config.SECURE_REGISTER_FILTER_PAGE,
    previousPage: config.SOLD_LAND_FILTER_URL,
    nextPage: [config.INTERRUPT_CARD_URL, config.USE_PAPER_URL]
  },
  ...
  [config.BENEFICIAL_OWNER_INDIVIDUAL_URL + config.ID]: {
    currentPage: config.BENEFICIAL_OWNER_INDIVIDUAL_PAGE,
    previousPage: config.BENEFICIAL_OWNER_TYPE_URL,
    nextPage: [config.BENEFICIAL_OWNER_TYPE_URL, config.BENEFICIAL_OWNER_INDIVIDUAL_URL + config.REMOVE + config.ID]
  },
  [config.BENEFICIAL_OWNER_OTHER_URL + config.ID]: {
    currentPage: config.BENEFICIAL_OWNER_OTHER_PAGE,
    previousPage: config.BENEFICIAL_OWNER_TYPE_URL,
    nextPage: [config.BENEFICIAL_OWNER_TYPE_URL, config.BENEFICIAL_OWNER_OTHER_URL + config.REMOVE + config.ID]
  },
  [config.BENEFICIAL_OWNER_GOV_URL + config.ID]: {
    currentPage: config.BENEFICIAL_OWNER_GOV_PAGE,
    previousPage: config.BENEFICIAL_OWNER_TYPE_URL,
    nextPage: [config.BENEFICIAL_OWNER_TYPE_URL, config.BENEFICIAL_OWNER_GOV_URL + config.REMOVE + config.ID]
  },
  [config.MANAGING_OFFICER_URL + config.ID]: {
    currentPage: config.MANAGING_OFFICER_PAGE,
    previousPage: config.BENEFICIAL_OWNER_TYPE_URL,
    nextPage: [config.BENEFICIAL_OWNER_TYPE_URL, config.MANAGING_OFFICER_URL + config.REMOVE + config.ID]
  },
  [config.MANAGING_OFFICER_CORPORATE_URL + config.ID]: {
    currentPage: config.MANAGING_OFFICER_CORPORATE_PAGE,
    previousPage: config.BENEFICIAL_OWNER_TYPE_URL,
    nextPage: [config.BENEFICIAL_OWNER_TYPE_URL, config.MANAGING_OFFICER_CORPORATE_URL + config.REMOVE + config.ID]
  },
  [config.TRUST_INFO_URL]: {
  ...
  [config.CHECK_YOUR_ANSWERS_URL]: {
    currentPage: config.CHECK_YOUR_ANSWERS_PAGE,
    previousPage: [config.BENEFICIAL_OWNER_TYPE_URL, config.TRUST_INFO_URL],
    nextPage: [config.CONFIRMATION_URL, config.PAYMENT_WITH_TRANSACTION_URL]
  }
};
