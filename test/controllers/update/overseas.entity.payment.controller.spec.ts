...
import { PAYMENT_PAID, UPDATE_CHECK_YOUR_ANSWERS_URL, UPDATE_CONFIRMATION_PAGE, UPDATE_CONFIRMATION_URL, UPDATE_PAYMENT_FAILED_PAGE, UPDATE_PAYMENT_FAILED_URL } from "../../../src/config";
...
describe('OVERSEAS ENTITY PAYMENT controller suit', () => {
  ...
  test(`should redirect to ${UPDATE_PAYMENT_FAILED_PAGE} page, if Payment failed through no change`, async () => {
    mockGetApplicationData.mockReturnValueOnce(
      {
