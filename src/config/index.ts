...
export const REMOVE_PAYMENT_FEE = getEnvironmentValue("REMOVE_PAYMENT_FEE");
...
export const REMOVE_CONFIRMATION_PAGE = "remove-confirmation";
...
export const UPDATE_REMOVE_PAGE = "remove";
...
export const REMOVE_CONFIRMATION_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + REMOVE_CONFIRMATION_PAGE;
...
export const UPDATE_REMOVE_ENTITY_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + UPDATE_REMOVE_PAGE;
