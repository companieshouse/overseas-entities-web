export enum ErrorMessages {
  ...
  DAY_OF_TRUST_CEASED = "The date the trust stopped being associated with this overseas entity must include a day",
  MONTH_OF_TRUST_CEASED = "The date the trust stopped being associated with this overseas entity must include a month",
  YEAR_OF_TRUST_CEASED = "The date the trust stopped being associated with this overseas entity must include a year",
  YEAR_LENGTH_OF_TRUST_CEASED = "The year of the date the trust stopped being associated with this overseas entity must include 4 numbers",
  DAY_LENGTH_OF_TRUST_CEASED = "The day of the date the trust stopped being associated with this overseas entity must include 1 or 2 numbers",
  MONTH_LENGTH_OF_TRUST_CEASED = "The month of the date the trust stopped being associated with this overseas entity must include 1 or 2 numbers",
  ...
  INVALID_DATE_OF_TRUST_CEASED = "The date the trust stopped being associated with this overseas entity must be a real date",
  ...
  DATE_NOT_IN_PAST_OR_TODAY_OF_TRUST_CEASED = "The date the trust stopped being associated with this overseas entity cannot be in the future",
  ...
  DAY_AND_MONTH_OF_TRUST_CEASED = "The date the trust stopped being associated with this overseas entity must include a day and month",
  MONTH_AND_YEAR = "Date must include a month and year",
  MONTH_AND_YEAR_OF_TRUST = "The trust date must include a month and year",
  MONTH_AND_YEAR_OF_TRUST_CEASED = "The date the trust stopped being associated with this overseas entity must include a month and year",
  DAY_AND_YEAR = "Date must include a day and year",
  DAY_AND_YEAR_OF_TRUST = "The trust date must include a day and year",
  DAY_AND_YEAR_OF_TRUST_CEASED = "The date the trust stopped being associated with this overseas entity must include a day and year",
