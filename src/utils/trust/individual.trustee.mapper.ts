...
export const mapIndividualTrusteeToSession = (
  ...
  const data = {
    ...
    sa_address_premises: formData.property_name,
    sa_address_line1: formData.address_line1,
    sa_address_line2: formData.address_line2,
    sa_address_care_of: '',
    sa_address_locality: formData.city,
    sa_address_region: formData.county,
    sa_address_country: formData.country,
    sa_address_postal_code: formData.postal_code,
    sa_address_po_box: '',
    ura_address_premises: formData.correspondence_property_name,
    ura_address_line1: formData.correspondence_address_line1,
    ura_address_line2: formData.correspondence_address_line2,
    ura_address_locality: formData.correspondence_city,
    ura_address_region: formData.correspondence_county,
    ura_address_country: formData.correspondence_country,
    ura_address_postal_code: formData.correspondence_postal_code,
    ura_address_care_of: '',
    ura_address_po_box: '',
  };
