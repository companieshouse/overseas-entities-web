...
export const ADDITIONAL_TRUSTS_INVOLVED_PAGE = "statement-additional-trusts";
...
export const UPDATE_ADDITIONAL_TRUSTS_INVOLVED_URL = UPDATE_AN_OVERSEAS_ENTITY_URL + ADDITIONAL_TRUSTS_INVOLVED_PAGE;
