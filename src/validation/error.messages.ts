...
// MAX Lengths
  ...
  MAX_ENTITY_PUBLIC_REGISTER_NAME_LENGTH = "Name of register must be 4000 characters or less",
  MAX_ENTITY_PUBLIC_REGISTER_NUMBER_LENGTH = "Registration number must be 32 characters or less",
  MAX_ENTITY_LEGAL_FORM_LENGTH = "Legal form must be 4000 characters or less",
  MAX_ENTITY_LAW_GOVERNED_LENGTH = "Governing law must be 4000 characters or less",
