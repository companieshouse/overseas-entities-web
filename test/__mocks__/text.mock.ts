...
export const BENEFICIAL_OWNER_TYPE_PAGE_REDIRECT = "Found. Redirecting to beneficial-owner-type";
...
export const ENTITY_PAGE_REDIRECT = "Found. Redirecting to entity";
